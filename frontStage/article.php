...
$articleId=str_replace("'","''",$_GET['articleID']);
if ($articleId!=""){
$articleSql = "SELECT * FROM events WHERE id = '".$articleId."'";
    ...
    <div class="heng_box heng_box_2 bg_gray">
        <div class="plan_com clearfix">
            ...
            <div class="titleBox">
                ...
                <div class="blockTitle">EVENT</div>
            ...
            <div class="tutorialContent">
                <?php echo $content;?>
                <img style="margin-top:60px" src='../backStage/<?php echo $picture;?>' class="tutorialImg"/>
            </div>

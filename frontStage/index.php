        ...
        <div class="plan_com clearfix">
            <div class="container">
                <div class="row c1_list">
                    <div class="col-md-4 col-sm-12 col-xs-12 border_right">
                        <div class="item">
                            <div class="c1_img"><img src="images/SquareClubLogo.png" class="img-responsive" /></div>
                            <div class="c1_titleText">ABOUT RPC</div>
                            <div class="c1_desc">
                                Club members, Club leaders,
                                Our aim, Club introduction
                            </div>
                            <div class="c1_btn"><a href="about.php">Learn More</a></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 border_right">
                        <div class="item">
                            <div class="c1_img"><img src="images/rockridge_square_logo.jpg" class="img-responsive" /></div>
                            <div class="c1_titleText">ALL CLUBS</div>
                            <div class="c1_desc">
                                All clubs in Rockridge, their introduction, events
                            </div>
                            <div class="c1_btn"><a href="allClubs.php#allClubs">Learn more</a></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 border_right">
                        <div class="item">
                            <div class="c1_img"><img src="images/QnA_logo.jpg" class="img-responsive" /></div>
                            <div class="c1_titleText">Q&A</div>
                            <div class="c1_desc">
                                Ask whatever you want to know, learn whatever you want to learn
                            </div>
                            <div class="c1_btn"><a href="q&a.php">Learn More</a></div>
                        </div>
                    </div>
                </div>
            </div>
